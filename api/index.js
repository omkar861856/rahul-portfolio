...
var MemStorage = class {
  ...
  async createContactSubmission(submission) {
    ...
    const contactSubmission = { ...submission, id, created_at };
...
var contactFormSubmissions = pgTable("contact_submissions", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
  email: text("email").notNull(),
  subject: text("subject").notNull(),
  message: text("message").notNull(),
  created_at: text("created_at").notNull().default((/* @__PURE__ */ new Date()).toISOString())
});
